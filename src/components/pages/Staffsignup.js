...
const Staffsignup = () => {
    ...
    function handlesubmit(event) {
       ...
       axios.post(`http://localhost:8092/api/signup`,
       {
        "username":username,
        "email":email,
        "password":password
    ...
    <div className="signup">
        ...
        <h4>Signup as Staff</h4>
            ...
            <input className="labelfield" type="text" id="email" name="email" value={email} onChange={(event => setEmail(event.target.value))} required/>
            ...
            <p>Already have an account? <Link to="/logincode2"><b>Login</b></Link></p>
    </form>
